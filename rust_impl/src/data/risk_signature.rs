...
pub const LOW_RISK_MAX: u32 = 29;
pub const MEDIUM_RISK_MAX: u32 = 54;
pub const HIGH_RISK_MAX: u32 = 89;
...
pub const RISK_FAMILY_RULES: &[RiskFamilyRule] = &[
    RiskFamilyRule {
        ...
        notes: "Remote memory, injection, and process manipulation behavior. Cap reduced because VirtualAlloc fires in game engines and multimedia apps.",
    },
    RiskFamilyRule {
        family: "Execution",
        family_cap: 12,
    ...
    RiskFamilyRule {
        ...
        notes: "Capstone-era control-flow abnormalities. Cap is low because large legitimate binaries always have complex control flow; this family only matters in combination with other evidence.",
    },
    RiskFamilyRule {
        family: "Metadata",
        family_cap: 3,
...
pub const RISK_CATEGORY_RULES: &[RiskCategoryRule] = &[
    ...
    RiskCategoryRule {
        ...
        category_cap: 8,
        multiplier: 0.80,
        notes: "LoadLibrary/GetProcAddress are present in almost every Windows binary; keep this very low.",
    },
    RiskCategoryRule {
    ...
    RiskCategoryRule {
        ...
        category_cap: 6,
        multiplier: 0.50,
        notes: "Timing checks are weak alone; GetTickCount and Sleep are in almost every binary.",
    },
    RiskCategoryRule {
    ...
    RiskCategoryRule {
        ...
        category_cap: 8,
        multiplier: 0.80,
        notes: "Encoded strings fire on many clean binaries; keep modest unless clustered with packing evidence.",
    },
    RiskCategoryRule {
        category: "Entropy",
        ...
        category_cap: 10,
        multiplier: 1.00,
        notes: "Entropy anomalies support packing/compression/obfuscation hypotheses, but compressed resources are common.",
    },
    RiskCategoryRule {
